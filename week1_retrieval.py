...
query=get_embedding("Is Greek Cuisine the best in the world?And if yes which year?","text-embedding-3-small")

similarities={}

for doc_name,doc_data in embeddings_dict.items():
    similarity=cosine_similarity(query,doc_data["embedding"])
